			...
			<div class="row">
				<div class="col-lg-8 mb-5 mb-lg-0">
					<div class="form-title">
						<h2>Modifica tu producto</h2>
						<p>Una vez que guardes los cambios del producto, se enviará al administrador para que apruebe el cambio</p>
					</div>
...
<!-- end footer -->
	...
	<!-- form validation js -->
	<script src="assets/js/registrarProducto_validar.js"></script>
	<!-- main js -->
