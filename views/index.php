...
<head>
	...
	<!-- title -->
	<title>A&I Sweet Desserts</title>
...
<body>
 ...
 <!-- loader  -->
 <!--<div class="loader_bg">
	<div class="loader"><img src="./views/assets/img/loading.gif" alt="#" /></div>
 </div>
-->
	<!-- header -->
			...
			<div class="row">
				<div class="col-lg-8 offset-lg-2 text-center">
					<div class="section-title">	
						...
						<p>Gran variedad de postres recien hechos con los mejores ingredientes para cualquier ocasion!</p>
					</div>
				</div>
			</div>
		...
		<div class="container">
			<div class="row">
				<div class="col-lg-6 col-md-12">
					<div class="abt-bg">
						<a href="https://www.youtube.com/watch?v=379kGNuOgWY" class="video-play-btn popup-youtube"><i class="fas fa-play"></i></a>
					</div>
				</div>
				<div class="col-lg-6 col-md-12">
					<div class="abt-text">
						<p class="top-sub">Desde hace como 2 semanas</p>
	...
	<div class="latest-news pt-150 pb-150">
		<div class="container">
			...
			<div class="row">
				<div class="col-lg-8 offset-lg-2 text-center">
					<div class="section-title">	
						<h3><span class="orange-text">Para</span> ti</h3>
						<p>Una seleccion de nuestros mejores productos para ti!</p>
					</div>
				</div>
			</div>
				...
				<div class="col-lg-4 col-md-6">
					<div class="single-latest-news">
						...
						<div class="news-text-box">
							...
							<a href="single-news.html" class="read-more-btn">más <i class="fas fa-angle-right"></i></a>
						</div>
					</div>
				</div>
				<div class="col-lg-4 col-md-6">
			...
			<div class="row">
				<div class="col-lg-12 text-center">
					<a href="shop.html" class="boxed-btn">Más</a>
				</div>
			</div>
		</div>
	</div>
