	...
	<div class="product-section mt-150 mb-150">
		<div class="container">
                ...
                <div class="col-md-12">
						...
						<div class="product-filters">
							<ul>
								...
								<li data-filter=".Aceptado">Aceptado</li>
								<li data-filter=".Rechazado">Rechazado</li>
			...
			<div class="row product-lists">
				<div class="col-lg-4 col-md-6 text-center Aceptado">
					<div class="single-product-item">
						<div class="product-image">
							<a href="single-product.php"><img src="assets/img/products/cupcake.png" alt=""></a>
						</div>
						<h3>Aceptado</h3>
						<p class="product-price"><span>cupcake fresa</span></p>
						<a href="editProducto.php" class="cart-btn"><i class="fas fa-shopping-cart"></i> Editar Producto</a>
					</div>
				</div>
				<div class="col-lg-4 col-md-6 text-center Rechazado">
					<div class="single-product-item">
						<div class="product-image">
							<a href="single-product.php"><img src="assets/img/products/purepng.png" alt=""></a>
						</div>
						<h3>Rechazado</h3>
						<p class="product-price"><span>cupcake</span></p>
						<a href="editProducto.php" class="cart-btn"><i class="fas fa-shopping-cart"></i> Editar Producto</a>
					</div>
				</div>
				<div class="col-lg-4 col-md-6 text-center Aceptado">
					<div class="single-product-item">
						...
						<h3>Aceptado</h3>
						<p class="product-price"><span>cupcake chocolate</span></p>
						<a href="editProducto.php" class="cart-btn"><i class="fas fa-shopping-cart"></i> Editar Producto</a>
					</div>
				</div>
